...
For final-polish releases, use complete locale-aware count phrases and distinguish average, transaction, and market prices. Keep ordinary translated UI separate from bilingual glossary terminology, apply localized fallback grammar only at the presentation boundary, and test rendered Russian output rather than catalog keys alone.
